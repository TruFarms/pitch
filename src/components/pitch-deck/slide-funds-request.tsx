  ...
  return (
    <Card className="w-full max-w-4xl h-[600px] flex flex-col justify-center">
      <CardHeader className="text-center">
        <CardTitle className="text-3xl font-bold">Funding Request & Use of Proceeds</CardTitle>
        <CardDescription>
      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 items-center">
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-center md:text-left">Use of Proceeds (based on $200k)</h3>
          <div className="space-y-4">
            <div className="flex flex-col gap-2">
              <div className="flex justify-between text-sm">
                <span><FlaskConical className="inline-block mr-2 h-4 w-4" />Extraction & C1D1 Lab</span>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between text-sm">
                <span><Package className="inline-block mr-2 h-4 w-4" />Product Packaging</span>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between text-sm">
                <span><Building className="inline-block mr-2 h-4 w-4" />Pre-Roll Equipment</span>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between text-sm">
                <span><ClipboardList className="inline-block mr-2 h-4 w-4" />Lease, Legal & Other</span>
        ...
        <div className="bg-muted/50 p-8 rounded-lg text-center">
          ...
          <p className="text-4xl font-bold text-primary">$150,000 - $220,000</p>
          <p className="text-muted-foreground mt-2">Startup Capital for Equipment & Operations</p>
